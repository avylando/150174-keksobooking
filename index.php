...
<main>
  <section class="map map--faded">
    <div class="map__pins">
      ...
      <button class="map__pin map__pin--main">
        <img src="img/main-pin-image.png" width="40" height="44" draggable="true">
  ...
  <div class="notice">
    ...
    <form class="notice__form notice__form--disabled" action="assets/setdata.php" method="post" enctype="multipart/form-data" autocomplete="off">
      ...
      <fieldset class="form__element" disabled>
        ...
        <select id="type" name="type">
          <option value="1">Лачуга</option>
          <option value="2" selected>Квартира</option>
          <option value="3">Дом</option>
          <option value="4">Дворец</option>
        </select>
      </fieldset>

      <fieldset class="form__element" disabled>
        <label for="price">Цена за ночь, руб.</label>
        <input id="price" name="price" type="number" placeholder="5000" min="1000" max="1000000" value="1000" required>
      </fieldset>
      ...
      <fieldset class="form__element features form__element--wide" disabled>
        ...
        <input type="checkbox" name="features[]" value="1" id="feature-wifi">
        <label class="feature feature--wifi" for="feature-wifi">Wi-Fi</label>

        <input type="checkbox" name="features[]" value="2" id="feature-dishwasher">
        <label class="feature feature--dishwasher" for="feature-dishwasher">Посудомоечная машина</label>

        <input type="checkbox" name="features[]" value="3" id="feature-parking">
        <label class="feature feature--parking" for="feature-parking">Парковка</label>

        <input type="checkbox" name="features[]" value="4" id="feature-washer">
        <label class="feature feature--washer" for="feature-washer">Стиральная машина</label>

        <input type="checkbox" name="features[]" value="5" id="feature-elevator">
        <label class="feature feature--elevator" for="feature-elevator">Лифт</label>

        <input type="checkbox" name="features[]" value="6" id="feature-conditioner">
      ...
      <fieldset class="form__element form__element--wide" disabled>
        ...
        <div class="form__photo-container">
          <div class="upload">
            <input type="file" id="images" multiple name='photos[]' accept="image/*">
...
<script src="js/show-card.js"></script>
<script src="js/debounce.js"></script>
<script src="js/data.js"></script>
<script src="js/map.js"></script>
<script src="js/synchronize-fields.js"></script>
